...
- When the release PR lands and CI passes for that merge commit, the release jobs create the tag, sign and notarize the app, and upload the packaged build to the GitHub release.
